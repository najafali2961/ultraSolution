...
<head>
    ...
    <link rel="icon" href="{{ asset('frontend/assets/src/img/logo/favicon.ico') }}">
...
<body class="zj" cz-shortcut-listen="true">
                ...
                <div class="hc qf nn/2">
                    <div class="ma pa tc lh hn fn ep">
                        ...
                        <h1 class="wow fadeInUp wa mh nh _h ck jl vm wm" data-wow-delay=".3s"
                            ...
                            <!-- <span class="ji"> Business </span> -->
                            <span class="txt-type ji" data-wait="3000"
                                data-words="[&quot;Startup&quot;, &quot;SaaS&quot;, &quot;Business&quot;, &quot;Agency&quot;]"><span
                                    class="txt">Business</span></span>
                        </h1>
                ...
                <div class="hc rf nn/2">
                    <div class="wow fadeInRight e ca ma ub hc zc hn" data-wow-delay=".3s"
                        ...
                        <div class="d x u on/12">
                            <img src="{{ asset('frontend/assets/src/img/hero/image-2.jpg') }}" alt="hero-image">
                        </div>
                        <div class="d q m ba">
                            <img src="{{ asset('frontend/assets/src/img/hero/image-1.jpg') }}" alt="hero-image">
                        ...
                        <div class="d r/2 m">
                            <svg width="120" height="120" viewBox="0 0 120 120" fill="none"
                                ...
                                <defs>
                                    <radialGradient id="paint0_angular_300_926" cx="0" cy="0" r="1"
            ...
            <div class="ja hb md pd">
                ...
                <div class="hc rf yl/2 nn/3">
                    <div class="wow fadeInUp ej ma oa nc lh rl" data-wow-delay=".35s"
                        style="visibility: hidden; animation-delay: 0.35s; animation-name: none;">
                        <div class="ma xa hb vb gc od pd ee ye df hi vi gj hj ij _j bk ck kk lk ul xl cm">
                            <svg width="44" height="44" viewBox="0 0 44 44" class="jf">
                                <path
                ...
                <div class="hc rf yl/2 nn/3">
                    <div class="wow fadeInUp ej ma nc lh rl" data-wow-delay=".45s"
                        style="visibility: hidden; animation-delay: 0.45s; animation-name: none;">
                        <div class="ma xa hb vb gc od pd ee ye df hi vi gj hj ij _j bk ck kk lk ul xl cm">
                            <svg width="44" height="44" viewBox="0 0 44 44" class="jf">
                                <path opacity="0.5"
        ...
        <div class="rf xi">
            ...
            <div class="wow fadeInUp e ba _d de uf wg mg im nm oo vo _p aq" data-wow-delay=".3s"
                    ...
                    <svg width="1174" height="560" viewBox="0 0 1174 560" fill="none"
                        ...
                        <g opacity="0.4" filter="url(#filter0_f_41_257)">
                            <rect x="450.531" y="279" width="272.933" height="328.051"
                                fill="url(#paint0_linear_41_257)"></rect>
                        </g>
                        <defs>
                            ...
                            <linearGradient id="paint0_linear_41_257" x1="425.16" y1="343.693" x2="568.181"
                                y2="660.639" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#ABBCFF"></stop>
                                <stop offset="0.859375" stop-color="#4A6CF7"></stop>
                            </linearGradient>
                        </defs>
                ...
                <div class="tabButtons hb hc od rd">
                    <button class="hc ie pf eh lg mh sh zh yi cj qj ck fk ap so hi ne rj" onclick="showPanel(0)">
                        About Us
                    </button>
                        ...
                        <div class="ja hb md od jh">
                            <div class="hc rf nn/2">
                                <div class="e ca qa sb xc fn">
                                    <div class="d q x">
                                        <img src="{{ asset('frontend/assets/src/img/about/image-1.jpg') }}"
                                            alt="about-image">
                                    </div>
                                    <div class="d u y/2 ba ed/2">
                                        <img src="{{ asset('frontend/assets/src/img/about/image-2.jpg') }}"
                                            alt="about-image">
            ...
            <div class="ja hb md pd">
                <div class="hc rf yl/2 nn/4">
                    <div class="wow fadeInUp ej ma oa lc lh mk" data-wow-delay=".2s"
                        ...
                        <div class="e ya _d de">
                            <img src="{{ asset('frontend/assets/src/img/team/image-1.jpg') }}" alt="team-image"
                                class="hc">
                            <div class="duration-300 d o r/2 dd/2 fd li vi fj jj">
                                <div class="hb od pd sd">
                                    <a href="javascript:void(0)" name="social-icon" aria-label="social-icon"
                                        class="hb lb zb od pd ee he oe pe af bf ii si vi zi _i aj">
                ...
                <div class="hc rf yl/2 nn/4">
                    <div class="wow fadeInUp ej ma oa lc lh mk" data-wow-delay=".25s"
                        style="visibility: hidden; animation-delay: 0.25s; animation-name: none;">
                        <div class="e ya _d de">
                            <img src="{{ asset('frontend/assets/src/img/team/image-2.jpg') }}" alt="team-image"
                                class="hc">
                            <div class="duration-300 d o r/2 dd/2 fd li vi fj jj">
                                <div class="hb od pd sd">
                                    <a href="javascript:void(0)" name="social-icon" aria-label="social-icon"
                ...
                <div class="hc rf yl/2 nn/4">
                    <div class="wow fadeInUp ej ma oa lc lh mk" data-wow-delay=".3s"
                        style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
                        <div class="e ya _d de">
                            <img src="{{ asset('frontend/assets/src/img/team/image-3.jpg') }}" alt="team-image"
                                class="hc">
                            <div class="duration-300 d o r/2 dd/2 fd li vi fj jj">
                                <div class="hb od pd sd">
                                    <a href="javascript:void(0)" name="social-icon" aria-label="social-icon"
    ...
    <section id="portfolio" class="zg fl bp">
        <div class="rf xi">
            ...
            <div class="hc">
                ...
                <div class="portfolio-grid ja hb md" style="position: relative; height: 675.719px;">
                    <div class="grid-sizer"></div>
                    <div class="grid-item ecom hc rf pn/3" style="position: absolute; left: 0px; top: 0px;">
                        <div class="wow fadeInUp ej e oa _d de" data-wow-delay=".2s"
                            style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
                            <img src="{{ asset('frontend/assets/src/img/portfolio/image-1.jpg') }}"
                                alt="portfolio-image" class="hc">

                            <div
                                class="duration-300 d p s hb gd od qd de re cf _f rf li ti vi fj jj nk zk cn lo zp 2xl:ud-left-8">
                                ...
                                <div class="pg cl xo bq">
                                    <a href="javascript:void(0)"
                                        class="dark:hover:us-bg-primary hb lb zb od pd ee ve ef ii _i aj gk">
                    ...
                    <div class="grid-item branding hc rf yl/2 nn/3"
                        ...
                        <div class="wow fadeInUp ej e oa _d de" data-wow-delay=".25s"
                            style="visibility: hidden; animation-delay: 0.25s; animation-name: none;">
                            <img src="{{ asset('frontend/assets/src/img/portfolio/image-2.jpg') }}"
                                alt="portfolio-image" class="hc">
                    ...
                    <div class="grid-item digital hc rf yl/2 nn/3"
                        style="position: absolute; left: 0px; top: 334.953px;">
                        <div class="wow fadeInUp ej e oa _d de" data-wow-delay=".3s"
                            style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
                            <img src="{{ asset('frontend/assets/src/img/portfolio/image-3.jpg') }}"
                                alt="portfolio-image" class="hc">
                    ...
                    <div class="grid-item ecom hc rf yl/2 nn/3"
                        style="position: absolute; left: 440px; top: 334.953px;">
                        <div class="wow fadeInUp ej e oa _d de" data-wow-delay=".35s"
                            style="visibility: hidden; animation-delay: 0.35s; animation-name: none;">
                            <img src="{{ asset('frontend/assets/src/img/portfolio/image-4.jpg') }}"
                                alt="portfolio-image" class="hc">
                ...
                <div class="wow fadeInUp e ba _d de gf hf nf ih jg ri ek xk gm mm wo" data-wow-delay=".3s"
                    ...
                    <div class="d m r/2 aa dd/2">
                        <svg width="1174" height="560" viewBox="0 0 1174 560" fill="none"
                            ...
                            <defs>
                                ...
                                <linearGradient id="paint0_linear_41_257" x1="425.16" y1="343.693"
                                    x2="568.181" y2="660.639" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#ABBCFF"></stop>
                                    <stop offset="0.859375" stop-color="#4A6CF7"></stop>
                                </linearGradient>
                            </defs>
                    ...
                    <div class="tns-outer" id="tns1-ow">
                        <div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button
                                type="button" data-controls="prev" tabindex="-1" aria-controls="tns1"><svg
                                    width="20" height="20" viewBox="0 0 20 20" class="jf">
                                    <path
                                ...
                                aria-controls="tns1"><svg width="20" height="20" viewBox="0 0 20 20"
                                    class="jf">
                                    <path
                                        d="M13.4767 9.16689L9.00671 4.69689L10.185 3.51855L16.6667 10.0002L10.185 16.4819L9.00671 15.3036L13.4767 10.8336H3.33337V9.16689H13.4767Z">
                                    </path>
                        ...
                        <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide
                            <span class="current">3</span> of 2
                        </div>
                        <div id="tns1-mw" class="tns-ovh">
                            <div class="tns-inner" id="tns1-iw">
                                <div class="testimonial-active tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                    id="tns1"
                                    style="transition-duration: 0s; transform: translate3d(-33.3333%, 0px, 0px);">
                                    <div class="testimonial-item tns-item tns-slide-cloned" aria-hidden="true"
                                        tabindex="-1">
                                        <div class="ja hb md od">
                                            ...
                                            <div class="hc rf nn/2">
                                                <div class="e ma za rb hc oc fn lg:mr-0">
                                                    <div class="d v _ ba">
                                                        <img src="{{ asset('frontend/assets/src/img/testimonial/image-1.jpg') }}"
                                                            alt="testimonial-image">
                                                        <div class="d i k aa wb hc he ne pe ye df ui tj uj _j ak">
                                                        </div>
                                                    </div>
                                                    <div class="d h n da">
                                    ...
                                    <div class="testimonial-item tns-item tns-slide-active" id="tns1-item0">
                                        <div class="ja hb md od">
                                            <div class="ha hc rf en nn/2">
                                                <div class="lh ep">
                                                    <p class="za mh sh yh gi ip dq">
                                    ...
                                    <div class="testimonial-item tns-item" id="tns1-item1" aria-hidden="true"
                                        tabindex="-1">
                                        <div class="ja hb md od">
                                            <div class="ha hc rf en nn/2">
                                                <div class="lh ep">
                    ...
                    <div class="hc rf">
                        <div class="hb md od pd">
                            <a href="javascript:void(0)" class="la hb ec od pd _f 2xl:ud-w-[180px]">
                                <img src="{{ asset('frontend/assets/src/img/brands/uideck.svg') }}" alt="image"
                                    class="jb lb hc kj">
                                <img src="{{ asset('frontend/assets/src/img/brands/uideck-2.svg') }}"
                                    alt="image" class="lb hc lj">
                            </a>
                            <a href="javascript:void(0)" class="la hb ec od pd _f 2xl:ud-w-[180px]">
                                <img src="{{ asset('frontend/assets/src/img/brands/tailadmin.svg') }}"
                                    alt="image" class="jb lb hc kj">
                                <img src="{{ asset('frontend/assets/src/img/brands/tailadmin-2.svg') }}"
                                    alt="image" class="lb hc lj">
                            </a>
                            <a href="javascript:void(0)" class="la hb ec od pd _f 2xl:ud-w-[180px]">
                                <img src="{{ asset('frontend/assets/src/img/brands/graygrids.svg') }}"
                                    alt="image" class="jb lb hc kj">
                                <img src="{{ asset('frontend/assets/src/img/brands/graygrids-2.svg') }}"
                                    alt="image" class="lb hc lj">
                            </a>
                            <a href="javascript:void(0)" class="la hb ec od pd _f 2xl:ud-w-[180px]">
                                <img src="{{ asset('frontend/assets/src/img/brands/lineicons.svg') }}"
                                    alt="image" class="jb lb hc kj">
                                <img src="{{ asset('frontend/assets/src/img/brands/lineicons-2.svg') }}"
                                    alt="image" class="lb hc lj">
                            </a>
                            <a href="javascript:void(0)" class="la hb ec od pd _f 2xl:ud-w-[180px]">
                                <img src="{{ asset('frontend/assets/src/img/brands/plainadmin.svg') }}"
                                    alt="image" class="jb lb hc kj">
                                <img src="{{ asset('frontend/assets/src/img/brands/plainadmin-2.svg') }}"
                                    alt="image" class="lb hc lj">
                            </a>
                        </div>
                    </div>
                ...
                <div class="ja hb md">
                        ...
                        <div class="wow fadeInUp oa" data-wow-delay=".2s"
                            ...
                            <div class="e ya _d de">
                                <a href="javascript:void(0)" class="fb">
                                    <img src="{{ asset('frontend/assets/src/img/blog/image-1.jpg') }}"
                                        alt="blog-image" class="hc">
                                </a>
                    ...
                    <div class="hc rf yl/2 nn/3">
                        <div class="wow fadeInUp oa" data-wow-delay=".3s"
                            ...
                            <div class="e ya _d de">
                                <a href="javascript:void(0)" class="fb">
                                    <img src="{{ asset('frontend/assets/src/img/blog/image-2.jpg') }}"
                                        alt="blog-image" class="hc">
                                </a>
                                <span class="d _ s de ye dg rf mh uh zh ii">
                                    Ui/Ux Design
                    ...
                    <div class="hc rf yl/2 nn/3">
                        <div class="wow fadeInUp oa" data-wow-delay=".4s"
                            ...
                            <div class="e ya _d de">
                                <a href="javascript:void(0)" class="fb">
                                    <img src="{{ asset('frontend/assets/src/img/blog/image-3.jpg') }}"
                                        alt="blog-image" class="hc">
                                </a>
                                <span class="d _ s de ye dg rf mh uh zh ii">
                                    Web Development
    ...
    <section id="support" class="zg fl bp">
        <div class="rf xi">
                    ...
                    <div class="hb md od ie fg oj qo">
                        ...
                        <div class="hc rf nn/2">
                            <div class="wow fadeInUp hb od" data-wow-delay=".2s"
                                ...
                                <a href="mailto:info@gostartup.com" class="mh vh fi ck qm kp eq">
                                    info@gostartup.com
                                </a>
                            </div>
                        </div>
            ...
            <div class="ma _c gh">
                <form class="wow fadeInUp" data-wow-delay=".2s" action="https://formbold.com/s/unique_form_id"
                    method="POST" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
                    <div class="ja hb md">
                        ...
                        <div class="hc rf">
                            <div class="oa">
                                ...
                                <textarea rows="4" name="message" id="message" placeholder="Type Message"
                                    class="hc kd ie _e _f sh zh fi ki qi dj nj ck jk"></textarea>
                            </div>
                        </div>
                ...
                <div class="d m r/2 aa dd/2">
                    <svg width="1215" height="259" viewBox="0 0 1215 259" fill="none"
                        ...
                        <defs>
                            ...
                            <linearGradient id="paint0_linear_63_363" x1="420.718" y1="263.543"
                                x2="585.338" y2="628.947" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#ABBCFF"></stop>
                                <stop offset="0.859375" stop-color="#4A6CF7"></stop>
                            </linearGradient>
                        </defs>
            ...
            <div class="ja hb md">
                    ...
                    <div class="ta">
                        ...
                        <div class="xd">
                            ...
                            <div>
                                ...
                                <a href="mailto:support@domain.com" class="mh sh fi cj ck hk">
                                    support@domain.com
                                </a>
                            </div>
                        </div>
                ...
                <div class="hc rf sk/2 am/12 rn/12 vp/12">
                    <div class="ta">
                        ...
                        <form class="e">
                            <input type="email" name="email" id="email" placeholder="Email address"
                                class="lq hc de he zf qg rg sh gi qi dj sj xj">
