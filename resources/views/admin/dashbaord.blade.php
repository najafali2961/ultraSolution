                                        ...
                                        <div class="col-auto">
                                            <div class="stat text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    class="align-middle feather feather-truck">
                                        ...
                                        <div class="col-auto">
                                            <div class="stat text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="align-middle feather feather-dollar-sign">
                                        ...
                                        <div class="col-auto">
                                            <div class="stat text-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                    class="align-middle feather feather-shopping-cart">
                ...
                <div class="card flex-fill w-100">
                    <div class="card-header">
                        <div class="float-end">
                            <form class="row g-2">
                                ...
                                <div class="col-auto">
                                    <input type="text" class="border-0 form-control form-control-sm bg-light rounded-2"
                    ...
                    <div class="pt-2 pb-3 card-body">
                        <div class="chart chart-sm">
                            ...
                            <canvas id="chartjs-dashboard-line" style="display: block; height: 250px; width: 437px;"
                                width="874" height="500" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="dropdown position-relative">
                                <a href="#" data-bs-toggle="dropdown" data-bs-display="static">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        class="align-middle feather feather-more-horizontal">
                            ...
                            <div class="py-3">
                                <div class="chart chart-xs">
                                    ...
                                    <canvas id="chartjs-dashboard-pie"
                                        style="display: block; height: 150px; width: 437px;" width="874"
            ...
            <div class="order-3 col-12 col-md-12 col-xxl-6 d-flex order-xxl-2">
                <div class="card flex-fill w-100">
                    ...
                    <div class="px-4 card-body">
                        <div id="world_map" style="height: 350px; background-color: transparent;" class="jvm-container">
                            <svg width="929" height="350">
                                <defs></defs>
                                <g id="jvm-regions-group"
                                    transform="scale(0.7941796871685924) translate(134.8802324018565, 0)">
                                    <path
                                ...
                                <g id="jvm-markers-group">
                                    <circle data-index="0" cx="683.0000008840416" cy="162.08252282081278" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="1" cx="594.7613330327097" cy="167.58123226253088" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="2" cx="448.1517425410237" cy="213.26335576530266" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="3" cx="719.2291910675103" cy="152.14821112483023" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="4" cx="666.6745616315134" cy="179.4393935042342" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="5" cx="294.26000469987457" cy="140.54309268025673" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="6" cx="206.2867542001514" cy="155.8323634846935" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="7" cx="267.1669615164635" cy="137.77867988471843" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="8" cx="441.17762924749826" cy="113.64925523750887" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                    <circle data-index="9" cx="434.0661640858166" cy="141.2406840659638" r="9"
                                        fill="#3B7DDD" fill-opacity="1" stroke="#fff" stroke-width="7"
                                        stroke-opacity="0.5" stoke-opacity="0.4" class="jvm-marker jvm-element">
                                    </circle>
                                </g>
                    ...
                    <div class="card-body d-flex">
                        <div class="align-self-center w-100">
                            <div class="chart">
                                ...
                                <div class="inline flatpickr-calendar animate" tabindex="-1">
                                    <div class="flatpickr-months"><span class="flatpickr-prev-month"><span
                                                class="fas fa-chevron-left" title="Previous month"></span></span>
                                        ...
                                        </div><span class="flatpickr-next-month"><span class="fas fa-chevron-right"
                                                title="Next month"></span></span>
                                    </div>
                                        ...
                                        <div class="flatpickr-rContainer">
                                            ...
                                            <div class="flatpickr-days" tabindex="-1">
                                                <div class="dayContainer"><span class="flatpickr-day prevMonthDay"
                                                        aria-label="December 29, 2024" tabindex="-1">29</span><span
                                                        class="flatpickr-day prevMonthDay"
                                                        aria-label="December 30, 2024" tabindex="-1">30</span><span
                                                        class="flatpickr-day prevMonthDay"
                                                        aria-label="December 31, 2024" tabindex="-1">31</span><span
                                                        class="flatpickr-day" aria-label="January 1, 2025"
                                                        tabindex="-1">1</span><span class="flatpickr-day"
                                                        aria-label="January 2, 2025" tabindex="-1">2</span><span
                                                        class="flatpickr-day" aria-label="January 3, 2025"
                                                        tabindex="-1">3</span><span class="flatpickr-day"
                                                        aria-label="January 4, 2025" tabindex="-1">4</span><span
                                                        class="flatpickr-day" aria-label="January 5, 2025"
                                                        tabindex="-1">5</span><span class="flatpickr-day"
                                                        aria-label="January 6, 2025" tabindex="-1">6</span><span
                                                        class="flatpickr-day" aria-label="January 7, 2025"
                                                        tabindex="-1">7</span><span class="flatpickr-day"
                                                        aria-label="January 8, 2025" tabindex="-1">8</span><span
                                                        class="flatpickr-day" aria-label="January 9, 2025"
                                                        tabindex="-1">9</span><span class="flatpickr-day"
                                                        aria-label="January 10, 2025" tabindex="-1">10</span><span
                                                        class="flatpickr-day" aria-label="January 11, 2025"
                                                        tabindex="-1">11</span><span class="flatpickr-day selected"
                                                        aria-label="January 12, 2025" tabindex="-1">12</span><span
                                                        class="flatpickr-day" aria-label="January 13, 2025"
                                                        tabindex="-1">13</span><span class="flatpickr-day"
                                                        aria-label="January 14, 2025" tabindex="-1">14</span><span
                                                        class="flatpickr-day" aria-label="January 15, 2025"
                                                        tabindex="-1">15</span><span class="flatpickr-day"
                                                        aria-label="January 16, 2025" tabindex="-1">16</span><span
                                                        class="flatpickr-day today" aria-label="January 17, 2025"
                                                        aria-current="date" tabindex="-1">17</span><span
                                                        class="flatpickr-day" aria-label="January 18, 2025"
                                                        tabindex="-1">18</span><span class="flatpickr-day"
                                                        aria-label="January 19, 2025" tabindex="-1">19</span><span
                                                        class="flatpickr-day" aria-label="January 20, 2025"
                                                        tabindex="-1">20</span><span class="flatpickr-day"
                                                        aria-label="January 21, 2025" tabindex="-1">21</span><span
                                                        class="flatpickr-day" aria-label="January 22, 2025"
                                                        tabindex="-1">22</span><span class="flatpickr-day"
                                                        aria-label="January 23, 2025" tabindex="-1">23</span><span
                                                        class="flatpickr-day" aria-label="January 24, 2025"
                                                        tabindex="-1">24</span><span class="flatpickr-day"
                                                        aria-label="January 25, 2025" tabindex="-1">25</span><span
                                                        class="flatpickr-day" aria-label="January 26, 2025"
                                                        tabindex="-1">26</span><span class="flatpickr-day"
                                                        aria-label="January 27, 2025" tabindex="-1">27</span><span
                                                        class="flatpickr-day" aria-label="January 28, 2025"
                                                        tabindex="-1">28</span><span class="flatpickr-day"
                                                        aria-label="January 29, 2025" tabindex="-1">29</span><span
                                                        class="flatpickr-day" aria-label="January 30, 2025"
                                                        tabindex="-1">30</span><span class="flatpickr-day"
                                                        aria-label="January 31, 2025" tabindex="-1">31</span><span
                                                        class="flatpickr-day nextMonthDay" aria-label="February 1, 2025"
                                                        tabindex="-1">1</span><span class="flatpickr-day nextMonthDay"
                                                        aria-label="February 2, 2025" tabindex="-1">2</span><span
                                                        class="flatpickr-day nextMonthDay" aria-label="February 3, 2025"
                                                        tabindex="-1">3</span><span class="flatpickr-day nextMonthDay"
                                                        aria-label="February 4, 2025" tabindex="-1">4</span><span
                                                        class="flatpickr-day nextMonthDay" aria-label="February 5, 2025"
                                                        tabindex="-1">5</span><span class="flatpickr-day nextMonthDay"
                                                        aria-label="February 6, 2025" tabindex="-1">6</span><span
                                                        class="flatpickr-day nextMonthDay" aria-label="February 7, 2025"
                                                        tabindex="-1">7</span><span class="flatpickr-day nextMonthDay"
                                                        aria-label="February 8, 2025" tabindex="-1">8</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table class="table my-0 table-borderless">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column w-100">
                                        <span class="mb-1 me-2 text-muted">65%</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column w-100">
                                        <span class="mb-1 me-2 text-muted">33%</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column w-100">
                                        <span class="mb-1 me-2 text-muted">50%</span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column w-100">
                                        <span class="mb-1 me-2 text-muted">80%</span>
                                        <div class="progress progress-sm bg-success-light w-100">
                                            <div class="progress-bar bg-success" role="progressbar"
                                                style="width: 80%;"></div>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column w-100">
                                        <span class="mb-1 me-2 text-muted">78%</span>
                ...
                <div class="card flex-fill w-100">
                    ...
                    <div class="card-body d-flex w-100">
                        <div class="align-self-center chart chart-lg">
                            ...
                            <canvas id="chartjs-dashboard-bar" style="display: block; height: 350px; width: 270px;"
                                width="540" height="700" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
                </div>
            </div>
