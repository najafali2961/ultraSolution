    ...
    var t = {
                ...
                , u = function (t, e, n) {
                    ...
                    for (l in v && (n = e),
                        ...
                        p = ((f = !h && g && void 0 !== g[l]) ? g : n)[l],
                            d = y && f ? a(p, r) : b && "function" == typeof p ? a(Function.call, p) : p,
                            g && s(g, l, p, t & u.U),
                            x[l] != p && i(x, l, d),
                            b && S[l] != p && (S[l] = p)
                };
        ...
        2923: function (t, e, n) {
            ...
            t.exports = function (t, e, n, m, b, y, g) {
                ...
                if (C && (w = l(C.call(new t))) !== Object.prototype && w.next && (u(w, k, !0),
        ...
        7025: function (t, e, n) {
            !function (t) {
                "use strict";
                var e, r = /^[a-z]+:/, o = /[-a-z0-9]+(\.[-a-z0-9])*:\d+/i, i = /\/\/(.*?)(?::(.*?))?@/, s = /^win/i, a = /:$/, c = /^\?/, u = /^#/, l = /(.*\/)/, f = /^\/{2,}/, p = /(^\/?)/, d = /'/g, h = /%([ef][0-9a-f])%([89ab][0-9a-f])%([89ab][0-9a-f])/gi, v = /%([cd][0-9a-f])%([89ab][0-9a-f])/gi, m = /%([0-7][0-9a-f])/gi, b = /\+/g, y = /^\w:$/, g = /[^/#?]/, x = "undefined" == typeof window && void 0 !== n.g && !0, S = !x && t.navigator && t.navigator.userAgent && ~t.navigator.userAgent.indexOf("MSIE"), w = x ? t.require : null, L = {
                    protocol: "protocol",
                    host: "hostname",
                    port: "port",
                    path: "pathname",
                ...
                function _(t, e) {
                    !function (t, e, n) {
                        var s, d, h;
                        e = e || O(),
                            x ? s = w("url").parse(e) : (s = document.createElement("a")).href = e;
                        var v, m, b = (m = {
                            path: !0,
                            query: !0,
                            hash: !0
                        },
                            (v = e) && r.test(v) && (m.protocol = !0,
                                m.host = !0,
                                o.test(v) && (m.port = !0),
                                i.test(v) && (m.user = !0,
                                    m.pass = !0)),
                            m);
                        for (d in h = e.match(i) || [],
                            L)
                            b[d] ? t[d] = s[L[d]] || "" : t[d] = "";
                        if (t.protocol = t.protocol.replace(a, ""),
                            ...
                            !b.protocol && g.test(e.charAt(0)) && (t.path = e.split("?")[0].split("#")[0]),
                            !b.protocol && n) {
    ...
    n.n = function (t) {
        ...
        function () {
            ...
            const c = () => {
                ...
                , h = (t, e) => {
                    if ("theme" === t) {
                        ...
                        document.querySelector(".js-stylesheet").setAttribute("href", "css/".concat(t, ".css")),
            ...
            const x = new MutationObserver((() => {
                document.body && (Object.keys(e.query).length > 0 ? (m(),
                    Object.entries(e.query).forEach((t => {
                        let [e, n] = t;
                        s[e] && s[e].includes(n) && (h(e, n),
                            y(e, n))
                    }
                    ))) : d(),
                    x.disconnect())
